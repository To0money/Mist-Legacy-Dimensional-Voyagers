Shader "Universal Render Pipeline/Stylized Surface"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Includes/StylizedInput.hlsl"
            #include "Includes/LitForwardPass_DR.hlsl"
            #include "Includes/Lighting_DR.hlsl"
